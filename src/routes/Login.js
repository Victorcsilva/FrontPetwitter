...
import {Heading,Stack, Link,Button,Input, Flex,Text,InputGroup,InputRightElement,} from '@chakra-ui/react';
 ...
 import React from "react";
  ...
  <Stack justifyContent={'center'} marginLeft={'32px'}>
    <Heading fontSize={['0%','36px']} color={'#00ACC1'} fontFamily= {'Open Sans'} 
        >Comece agora.<p>Conecte-se já.</p></Heading>
       <Heading fontSize={'24px'}  fontFamily= {'Open Sans'} fontWeight={'600'} marginTop={'32px'}
        > Login </Heading>
          <Flex 
              as="form"
              mt="20px"
             ...
             <Button h='1.75rem' size='sm' onClick={handleClick}>
              ...
              <Button 
               ...
               <Heading fontSize={'16px'} fontStyle={'normal'} fontFamily= {'Open Sans'} fontWeight={'400'}> Ainda não possui uma conta? 
                 <Link as={ReachLink} to= "/signup" color='#00ACC1' href='#'> Cadastrar-se</Link> 
               </Heading> 
           </Stack>
  );
}
