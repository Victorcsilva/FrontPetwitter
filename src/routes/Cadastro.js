...
<Flex display={'flex'} direction={['column', 'row']} >
  ...
  <Flex as="form" mt="20px">
    <Stack maxWidth={['300px','100%']}  justifyContent={'center'} marginTop={'32px'}>  
       <Text mb='8px'>Nome:</Text>
         <Input name="Nome" type="text" placeholder="Nome"  focusBorderColor='#00ACC1'/>
            <Text mb='8px'>E-mail:</Text>
               <Input name="email" type="text" placeholder="E-mail" focusBorderColor='#00ACC1'/>
                 <Text mb='8px'>Nome de usuário:</Text>
                    <Input name="Nome de usuário" type="text" placeholder="Nome de usuário"focusBorderColor='#00ACC1'/>
